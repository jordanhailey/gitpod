...
import { testContainerIO } from '@gitpod/gitpod-db/lib/ee/src/test-container';
import { hoursLater, rightBefore, rightAfter, oneMonthLater } from '@gitpod/gitpod-protocol/lib/util/timeutil';
import { DBWorkspace, DBWorkspaceInstance, WorkspaceDB, UserDB, DBUser, DBIdentity } from '@gitpod/gitpod-db/lib/src';
import { DBAccountEntry } from '@gitpod/gitpod-db/lib/ee/src/typeorm/entity/db-account-entry';
import { TypeORMEE } from '@gitpod/gitpod-db/lib/ee/src/typeorm/typeorm';
...
import { DBSubscription } from '@gitpod/gitpod-db/lib/ee/src/typeorm/entity/db-subscription';
import { AccountingDB } from '@gitpod/gitpod-db/lib/ee/src/accounting-db';
...
@suite class AccountServiceSpec {
    typeORM = localTestContainer.get<TypeORMEE>(TypeORMEE);
...
const localTestContainer = testContainerIO.createChild();
