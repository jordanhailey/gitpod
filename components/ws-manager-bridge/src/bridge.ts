...
import { WorkspaceDB } from "@gitpod/gitpod-db/lib/src/workspace-db";
import { UserDB } from "@gitpod/gitpod-db/lib/src/user-db";
...
import { TracedWorkspaceDB, TracedUserDB, DBWithTracing } from '@gitpod/gitpod-db/lib/src/traced-db';
